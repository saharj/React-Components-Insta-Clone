const dummyData = [
  ...
  },
  {
    ...
    thumbnailUrl:
      "https://icon2.cleanpng.com/20180320/sqe/kisspng-twitch-computer-icons-streaming-media-youtube-live-tv-twitch-icon-5ab19172461392.001176751521586546287.jpg",
    imageUrl:
      "https://images.unsplash.com/photo-1584046059168-28ef601da2ca?ixlib=rb-1.2.1&ixid=eyJhcHBfaWQiOjEyMDd9&auto=format&fit=crop&w=2850&q=80",
    likes: 947,
    timestamp: "May 5th 2019, 10:22:09 am",
    comments: [
      {
        id: 3,
        username: "Lucy",
        text: "It is time to relax!",
      },
      {
        id: 6,
        username: "daniel_p",
